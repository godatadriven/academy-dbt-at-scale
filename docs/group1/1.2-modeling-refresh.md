...
??? tip "This is exactly the kind of thing dbt Wizard is good at"
      In the real world, this is boilerplate you'd hand to dbt Wizard with a precise, file-scoped prompt and then review the diff it proposes. For this training, write it by hand instead - it forces you to actually read the SQL you're documenting, which is the point of the exercise.
