...
2. **Apply severity and error_if/warn_if deliberately**
...
1. **Classify your existing tests**
...
2. **Connect this to access and contracts**
...
3. **Upgrade one test to public-contract grade**
